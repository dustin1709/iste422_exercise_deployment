...
public class ParseSave extends EdgeConvertFileParser{
        private static Logger logger = LogManager.getLogger(ParseEdge.class.getName());

   public ParseSave(File constructorFile) {
